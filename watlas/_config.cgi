...
# ◆はじめにする設定
#-----------------------
$MASTER_PASSWORD	='1234';			# 管理パスワード
$ADMIN_EMAIL		='a@a.com';			# 管理者メールアドレス
...
$DATE_REVISE_TIME	=3600*7;		# 決算時刻をずらす秒数(-3600で1時間前倒し)
...
$BAL_NAME	='ハイレディン';		# 反乱ＮＰＣの名前
$BAL_JOB	='海賊王';			# 反乱ＮＰＣの職業
